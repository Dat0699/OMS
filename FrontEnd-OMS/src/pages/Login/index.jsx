    ...
    return (
        <div className="login-page flex flex-col" style={{justifyContent: "space-around", alignItems: "center"}}>
            <div className="flex flex-col">
                <div className="label-filed" style={{marginBottom: '220px !important', margin: '53px !important'}}>
                ...
                <Modal 
                    visible={true}
                    content={(
                        <div className="form-login section-col" style={{justifyContent: 'space-evenly', position:'unset !important'}}>
